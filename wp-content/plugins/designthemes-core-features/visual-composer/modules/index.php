...
$attributes = array(
    ...
    'description' => esc_html__( 'Select type of animation for element to be animated when it "enters" the browsers viewport (Note: works only in modern browsers).', 'designthemes-core' ),
	'weight' => 1
);
vc_add_param( 'vc_column_inner', $attributes );
