...
Plugin generate newsletters automatically with latest available posts and send to subscriber. We can easily schedule daily, weekly or monthly.
...
1. Do you want to send newsletter daily with list of posts published yesterday? YES, This plugin will do for you.

2. Do you want to send newsletter automatically on Saturday with list of posts published this week? YES, This plugin will do for you.

3. Do you want to send notification email whenever new post published in your website? YES, This plugin will do for you.

4. Do you want to create a HTML newsletter and send manually (Or Schedule) to subscribers? YES, This plugin will do for you.
...
2. Subscriber management page. http://www.gopiplus.com/work/2014/03/30/subscriber-management-for-email-posts-to-subscribers-plugin/

3. Mail template management page. http://www.gopiplus.com/work/2014/03/31/newsletter-templates-for-email-posts-to-subscribers-plugin/

4. Mail configuration management page. http://www.gopiplus.com/work/2014/03/30/mail-configuration-for-email-posts-to-subscribers-plugin/

5. Post notification management page. http://www.gopiplus.com/work/2016/10/25/post-notification-setting-for-email-posts-to-subscribers-plugin/

6. Compose newsletter. http://www.gopiplus.com/work/2016/11/02/compose-send-newsletter-in-email-posts-to-subscribers-plugin/

7. Send mail Manually. http://www.gopiplus.com/work/2014/03/30/email-posts-to-subscribers-wordpress-plugin-send-email/

8. Send mail Manually. http://www.gopiplus.com/work/2014/03/30/email-posts-to-subscribers-wordpress-plugin-send-email/

9. Sent mail. http://www.gopiplus.com/work/2014/03/30/email-posts-to-subscribers-wordpress-plugin-send-email/

10. Plugin settings management page. http://www.gopiplus.com/work/2014/03/31/general-settings-for-email-posts-to-subscribers-plugin/

11. Plugin settings management page. http://www.gopiplus.com/work/2014/03/31/general-settings-for-email-posts-to-subscribers-plugin/

12. Plugin settings management page. http://www.gopiplus.com/work/2014/03/31/general-settings-for-email-posts-to-subscribers-plugin/

13. Plugin settings management page. http://www.gopiplus.com/work/2014/03/31/general-settings-for-email-posts-to-subscribers-plugin/

14. Plugin settings management page. http://www.gopiplus.com/work/2014/03/31/general-settings-for-email-posts-to-subscribers-plugin/

15. Cron details management page. http://www.gopiplus.com/work/2014/03/31/schedule-auto-mails-cron-jobs-for-email-posts-to-subscribers-plugin/

16. Roles and capabilities page. http://www.gopiplus.com/work/2014/03/28/wordpress-plugin-email-posts-to-subscribers/

16. reCaptcha option. http://www.gopiplus.com/work/2019/11/17/email-posts-to-subscribers-plugin-security-feature/

16. Security menu. http://www.gopiplus.com/work/2019/11/17/email-posts-to-subscribers-plugin-security-feature/
...
1. Tested up to 5.2.2

= 5.0 =

1. Tested up to 5.3
2. Redesign plugin admin menus.
3. Ajax option introduced in the subscriber form. Thus no refresh in the subscriber submission.
4. Time option added in the mail configuration. Now we can schedule the mail on specify day and specific time.

= 5.1 =

1. Post type selection option is added in the mail configuration.
2. Added more security option in the form submission (Option to block the submission by Domain, IP).
3. Throttling mechanism is added to protect spam submission.
4. Option added to filter bad word in the submission name.
5. Plugin date time format is changed in the admin to display as per default format of the blog.
6. New default template design is added in the plugin template section.

= 5.2 =

1. Bug fix - Short code
2. Bug fix - The REST API encountered an error
3. Languages files refreshed.

= 5.3 =

1. Bug fix - Post type
2. Bug fix - Mail Configuration
3. Updated time selection drop box.

= 5.4 =

1. Enhancement in post notification module. Notification emails will not send immediately instead it will take few minutes.
2. New admin page added to view notification queue.
3. Old records (from sent mail menu) will be deleted automatically.

= 5.4.1 =

1. Notification email added in the CRON url

= 5.4.2 =

<span> tag added for the subscriber box caption. Now we can hide Name and Email caption in the subscriber form using below CSS class.

.email_posts_subscribers .name { display: none; }
.email_posts_subscribers .email { display: none; }

= 5.4.3 =

1. Text search option added in the subscriber admin page.
2. Open rate display is added in the Sent Mail admin page.

= 5.5 =

1. Bulk delete option added in notification queue.
...
1. Bug fix on Admin Mail Configuration page.
...
2. Redesign plugin admin menus.
3. Ajax option introduced in the subscriber form. Thus no refresh in the subscriber submission.
4. Time option added in the mail configuration. Now we can schedule the mail on specific day and specific time.
