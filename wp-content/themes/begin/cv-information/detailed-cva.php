...
// echo "Avg_Reff_Fees_To_Emp_Eighteen_More".$Avg_Reff_Fees_To_Emp_Eighteen_More;
 ...
 $Average_utilisation_age = $_POST['Average_utilisation_age'];
 $Under_utilised_employees = $_POST['Under_utilised_employees'];
 $desired_employee = $_POST['desired_employee'];
 
  //echo $desired_employee;
...
/****6. point  *****/
 ...
 $Current_Cost_Of_All_Above_Per_Annum = $_POST['Current_Cost_Of_All_Above_Per_Annum'];
...
// echo "Savings_Contract_Consulting_PartTIme".$Savings_Contract_Consulting_PartTIme;
 ...
 $Revenue_Placement_Of_Bench = ($_POST['Avg_Annual_Bench'] *$_POST['benched_employee'] +$_POST['Number_Under_utilised_employee']*$_POST['Under_utilised_employees']*$_POST['Average_utilisation_age']/100)*(1+$_POST['desired_employee']/100);
...
//echo "Revenue_Placement_Of_Bench".$Revenue_Placement_Of_Bench;
 ...
 $query="INSERT INTO `detailed_cva`(`id`, `company_name`, `industry`, `email`, `Name`, `Designation`, `Phone`, `Planned_Recru_Third_Party_Zero_Five`, `Planned_Recru_Third_Party_Five_Tweleve`, `Planned_Recru_Third_Party_Tweleve_Eighteen`, `Planned_Recru_Third_Party_Eighteen_More`, `Planned_Recru_Emp_Referral_Zero_Five`, `Planned_Recru_Emp_Referral_Five_Tweleve`, `Planned_Recru_Emp_Referral_Tweleve_Eighteen`, `Planned_Recru_Emp_Referral_Eighteen_More`, `Avg_CTC_Hire_PerAnnum_Zero_Five`, `Avg_CTC_Hire_PerAnnum_Five_Tweleve`, `Avg_CTC_Hire_PerAnnum_Tweleve_Eighteen`, `Avg_CTC_Hire_PerAnnum_Eighteen_More`, `Avg_Recru_Charges_Third_Party_PerHire_Zero_Five`, `Avg_Recru_Charges_Third_Party_PerHire_Five_Tweleve`, `Avg_Recru_Charges_Third_Party_PerHire_Tweleve_Eighteen`, `Avg_Recru_Charges_Third_Party_PerHire_Eighteen_More`, 
`Avg_Reff_Fees_To_Emp_Zero_Five`, `Avg_Reff_Fees_To_Emp_Five_Tweleve`, `Avg_Reff_Fees_To_Emp_Tweleve_Eighteen`, `Avg_Reff_Fees_To_Emp_Eighteen_More`, `Contractual_hires`,
 `contract_per_annum`, `Contractual_hires_charges`, `Contractual_Consult_Hire_Per_Year`, `Avg_Cost_Consult_Per_Annum`, `Avg_Recru_Charges`, `Part_Time_Hire_For_Year`,
 `Avg_Cost_PartTime_Emp_Per_Annum`, `Contractual_Avg_Recru_Charges`, `planned_Re_assignment`, `Severence_period`, `employee_reporting_currency`, `Approximate_effort`,
 `Approximate_per_man`, `cost_external_consulting`, `cost_brand_erosion`, `Legal_external_consulting`, `Avg_Annual_Bench`, `Average_overheads`, `benched_employee`,
 `Number_Under_utilised_employee`, `Average_utilisation_age`, `Under_utilised_employees`, `desired_employee`, `planned_Re_assignment_Profits`, `Current_Cost_Of_All_Above_Per_Annum`, `Savings_Full_Time_Hire`,
 `Savings_Contract_Consulting_PartTIme`, `Savings_Reassignmetn_Retrenchment`, `Revenue_Placement_Of_Bench`, `Total_Value`, `Net_Profit_Percentage`) VALUES ( NUll,'$company_name', '$industry', '$email','$Name', '$Designation', '$Phone','$Planned_Recru_Third_Party_Zero_Five', '$Planned_Recru_Third_Party_Five_Tweleve',
 '$Planned_Recru_Third_Party_Tweleve_Eighteen','$Planned_Recru_Third_Party_Eighteen_More', '$Planned_Recru_Emp_Referral_Zero_Five', '$Planned_Recru_Emp_Referral_Five_Tweleve', 
 '$Planned_Recru_Emp_Referral_Tweleve_Eighteen','$Planned_Recru_Emp_Referral_Eighteen_More', '$Avg_CTC_Hire_PerAnnum_Zero_Five', '$Avg_CTC_Hire_PerAnnum_Five_Tweleve',
'$Avg_CTC_Hire_PerAnnum_Tweleve_Eighteen','$Avg_CTC_Hire_PerAnnum_Eighteen_More', '$Avg_Recru_Charges_Third_Party_PerHire_Zero_Five', 
'$Avg_Recru_Charges_Third_Party_PerHire_Five_Tweleve','$Avg_Recru_Charges_Third_Party_PerHire_Tweleve_Eighteen', '$Avg_Recru_Charges_Third_Party_PerHire_Eighteen_More', 
'$Avg_Reff_Fees_To_Emp_Zero_Five','$Avg_Reff_Fees_To_Emp_Five_Tweleve', '$Avg_Reff_Fees_To_Emp_Tweleve_Eighteen', '$Avg_Reff_Fees_To_Emp_Eighteen_More', '$Contractual_hires', 
'$contract_per_annum','$Contractual_hires_charges', '$Contractual_Consult_Hire_Per_Year', '$Avg_Cost_Consult_Per_Annum', '$Avg_Recru_Charges', '$Part_Time_Hire_For_Year', 
'$Avg_Cost_PartTime_Emp_Per_Annum','$Contractual_Avg_Recru_Charges', '$planned_Re_assignment', '$Severence_period', '$employee_reporting_currency', '$Approximate_effort', 
'$Approximate_per_man','$cost_external_consulting', '$cost_brand_erosion', '$Legal_external_consulting', '$Avg_Annual_Bench', '$Average_overheads',  '$benched_employee', 
...
if ($conn->query($query) === TRUE) {
  ...
  header("Location: https://skillbeyondboundaries.com/detailedcva/?success=oks");  
