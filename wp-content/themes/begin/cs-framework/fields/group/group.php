...
class CSFramework_Option_group extends CSFramework_Options {
  ...
  public function output() {
    ...
    $acc_title   = ( isset( $this->field['accordion_title'] ) ) ? $this->field['accordion_title'] : esc_html__( 'Adding', 'begin' );
    ...
    echo '<div class="cs-group cs-group-'. esc_attr( $el_class ) .'-adding hidden">';
      ...
      echo '<h4 class="cs-group-title">'. esc_html( $acc_title ) .'</h4>';
      ...
      echo '<div class="cs-element cs-text-right cs-remove"><a href="#" class="button cs-warning-primary cs-remove-group">'. esc_html__( 'Remove', 'begin' ) .'</a></div>';
      echo '</div>';
    ...
    echo '<div class="cs-groups cs-accordion">';
      ...
      if( ! empty( $this->value ) ) {
        ...
        foreach ( $this->value as $key => $value ) {
          ...
          echo '<h4 class="cs-group-title">'. esc_html( $field_title .': '. $title ) .'</h4>';
          echo '<div class="cs-group-content">';
    ...
    echo '<a href="#" class="button button-primary cs-add-group">'. esc_html( $this->field['button_title'] ).'</a>';
