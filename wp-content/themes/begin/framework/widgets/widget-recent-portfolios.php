<?php
class Begin_Portfolio_Widget extends WP_Widget {
	#1.constructor
	function __construct() {
		$widget_options = array("classname"=>'widget_popular_entries', 'description'=>esc_html__('To list out portfolio items', 'begin'));
		parent::__construct(false,BEGIN_THEME_NAME.esc_html__(' Portfolio','begin'),$widget_options);
	}
...
<?php
	...
	function widget($args, $instance) {
		...
		$arg = empty($_post_categories) ? $arg : array(
											...
											'tax_query'		=> array(array( 'taxonomy'=>'portfolio_entries', 'field'=>'term_id', 'operator'=>'IN', 'terms'=>$_post_categories ) ));
		echo ($before_widget);
		...
		echo "<div class='recent-portfolio-widget'><ul>";
			 ...
			 if($the_query->have_posts()) :
			 	...
			 	echo "<li>".esc_html__('No Portfolio Entries found','begin')."</li>";
			 endif;
			 wp_reset_postdata();
	 	echo "</ul></div>";			 
		echo ($after_widget);
